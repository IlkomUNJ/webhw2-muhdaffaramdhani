// Definisikan objek sweetbox secara langsung di scope global
window.sweetbox = {
    // --- Keranjang ---
...
// Jalankan kode yang berinteraksi dengan DOM setelah DOM selesai dimuat
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.body.addEventListener('click', (e) => {
        ...
        if (addToCartBtn) {
            e.preventDefault(); // Mencegah aksi default jika elemennya adalah <a>
